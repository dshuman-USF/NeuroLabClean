...
set time_left [expr $sample / 25000.0]
set pick_x -1
set nopaint 0
set ymag 1
...
proc set_dr_times {} {
    ...
    set time_right [expr $time_left + $samples_per_width / 25000.0]
    set time_diff [expr $time_right - $time_left]
    update  idletasks
}
...
proc mouse {cwin cx cy} {
    ...
    set width [winfo width .sq]
    set mouse_time [expr ($sample + $cx / $xscale) / 25000.0]
    set mouse_samp [expr ($sample + $cx / $xscale)]
    set mouse_time_offset [expr $mouse_time + .00246]
    place forget .sq.fcm
